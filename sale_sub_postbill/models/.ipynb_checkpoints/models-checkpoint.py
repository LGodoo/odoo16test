...
class PostBilling(models.Model):
    ...
    # Updated on 08.11.2022 as per Odoo code and our csutomisations
...
class SaleOrderLine(models.Model):
    ...
    # Updated def to take start date until correct end date in the period_msg = _("Invoicing period: %s - %s")
    ...
    def _prepare_invoice_line(self, **optional_values):
        ...
        if self.subscription_id:
            ...
            if not is_already_period_msg:
                ...
                if self.subscription_id.post_billed == True and self.subscription_id.recurring_rule_type == 'monthly':
